...
import yar.quadraturin.config.InputBinding;
import yar.quadraturin.config.InputConfig;
import yar.quadraturin.events.CursorEvent;
import yar.quadraturin.events.InputHook;
